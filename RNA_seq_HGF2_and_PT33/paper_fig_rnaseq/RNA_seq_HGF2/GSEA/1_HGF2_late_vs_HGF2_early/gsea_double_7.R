...
setwd("/home/alexis/Desktop/RESULTADOS_FINALES_ERGO/kallisto_TRABAJADO/HGF2/descargados_ERGO_deseq2/GSEA/1_HGF2_late_vs_HGF2_early")

# Carga tus datos
upregulated_ergo <- read_csv("gage (ergo): HGF2_Late - HGF2_Early upregulated.csv")
downregulated_ergo <- read_csv("gage (ergo): HGF2_Late - HGF2_Early downregulated.csv")
...
categorias_excluir <- c("PRPPGLNIMP.ANA", "TAT_pathway_secreted_proteins", "TAT_pathway",
                        ...
                        "Cytosolic_reactions_of_nitrogen_metabolism", "N_acetylglucosamine_membrane_transport",
...
downregulated_filtered_clean$Name[downregulated_filtered_clean$Name == "D_glucose_uptake_mannose_PTS_forming_glucose_6_phosphate"] <- "D_glucose_uptake_mannose_PTS"
downregulated_filtered_clean$Name[downregulated_filtered_clean$Name == "D_mannose_uptake_mannose_PTS_forming_mannose_6_phosphate"] <- "D_mannose_uptake_mannose_PTS"
...
titulo_principal <- "HGF2_Single_Late_vs_HGF2_Single_Early"
...
path_to_file <- "/home/alexis/Desktop/github_script_finales_alexis/Objective_3_cocultures_vs_monocultures_RNAseq/RNA_seq/RNA_seq_Clostridium_HGF2/GSEA/1_HGF2_late_vs_HGF2_early/combined_table_7.csv"
