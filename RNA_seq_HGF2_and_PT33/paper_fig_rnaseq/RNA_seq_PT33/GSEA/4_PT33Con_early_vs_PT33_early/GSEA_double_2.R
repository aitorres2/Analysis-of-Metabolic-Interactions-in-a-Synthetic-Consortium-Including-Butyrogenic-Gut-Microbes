...
setwd("/home/alexis/Desktop/RESULTADOS_FINALES_ERGO/kallisto_TRABAJADO/PT33/descargados_ERGO_deseq2/GSEA_gage/4_PT33Con_early_vs_PT33_early")

# Carga tus datos
upregulated_ergo <- read_csv("gage (ergo): Consortium_Early - PT8_Early_upregulated.csv")
downregulated_ergo <- read_csv("gage (ergo): Consortium_Early - PT8_Early_downregulated.csv")
...
titulo_principal <- "PT33_Consortium_Early_vs_PT33_Single_Early"
...
# Guardar la imagen
ggsave("combined_ergo_plot_2.png", combined_plot, width = 23, height = 15, dpi = 600)
...
path_to_file <- "/home/alexis/Desktop/github_script_finales_alexis/Objective_3_cocultures_vs_monocultures_RNAseq/RNA_seq/RNA_seq_Bi_animalis_lactis_PT33/GSEA/4_PT33Con_early_vs_PT33_early/combined_table_2.csv"
