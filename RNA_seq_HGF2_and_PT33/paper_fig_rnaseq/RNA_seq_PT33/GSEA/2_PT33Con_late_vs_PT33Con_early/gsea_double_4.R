...
setwd("/home/alexis/Desktop/RESULTADOS_FINALES_ERGO/kallisto_TRABAJADO/PT33/descargados_ERGO_deseq2/GSEA_gage/2_PT33Con_late_vs_PT33Con_early")

# Carga tus datos
upregulated_ergo <- read_csv("gage (ergo): Consortium_Late - Consortium_Early upregulated.csv")
downregulated_ergo <- read_csv("gage (ergo): Consortium_Late - Consortium_Early downregulated.csv")
...
titulo_principal <- "PT33_Consortium_Late_vs_PT33_Consortium_Early"
...
path_to_file <- "/home/alexis/Desktop/github_script_finales_alexis/Objective_3_cocultures_vs_monocultures_RNAseq/RNA_seq/RNA_seq_Bi_animalis_lactis_PT33/GSEA/2_PT33Con_late_vs_PT33Con_early/combined_table_4.csv"
