...
path_to_file <- "/home/alexis/Desktop/github_script_finales_alexis/Objective_3_cocultures_vs_monocultures_RNAseq/RNA_seq/RNA_seq_Bi_animalis_lactis_PT33/GSEA/1_PT33_late_vs_PT33_early/combined_table_3.csv"
