...
path_to_file <- "/home/alexis/Desktop/github_script_finales_alexis/Objective_3_cocultures_vs_monocultures_RNAseq/RNA_seq/RNA_seq_Clostridium_HGF2/GSEA/4_HGF2Con_early_vs_HGF2_early/combined_table_6.csv"
